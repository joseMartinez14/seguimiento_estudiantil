...
<head>
    ...
    <title>Solicitudes de seguimientos</title>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody id="tabla-solicitudes">
                            ...
                            <tr style="height: 10px">
                                ...
                                <td>{{App\Models\User::find(App\Models\estudiante::find($seguimiento->estudiante_id)->id)->name}} {{App\Models\User::find(App\Models\estudiante::find($seguimiento->estudiante_id)->id)->apellido}}</td>
