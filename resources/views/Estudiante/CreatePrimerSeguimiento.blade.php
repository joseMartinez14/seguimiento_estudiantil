...
<body>
  ...
  <div class="form-card">
    ...
    <h4 style="text-align: center;">SOLICITUD DEL PRIMER SEGUIMIENTO</h4>
...
<script>
  ...
  function recolectarDatosGUI() {
    datos = {
      ...
      materia: $('#campo-materia').val(),
      profesor: $('#campo-profesor').val(),
      creditos: $('#campo-creditos').val(),
      situacion: $('#campo-situacion').val(),
